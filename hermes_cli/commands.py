...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("model", "Switch model for this session", "Configuration",
               aliases=("m",), args_hint="[model] [--provider name] [--global]"),
    CommandDef("ask", "Switch to ask mode (read-first, low-side-effect)", "Configuration",
               aliases=("a",)),
    CommandDef("analyze", "Switch to analyze mode (inspect, debug, investigate)", "Configuration",
               aliases=("analyse", "an",)),
    CommandDef("build", "Switch to build mode (full toolset)", "Configuration",
               aliases=("b",)),
    CommandDef("mode", "Show or change the current agent mode", "Configuration",
               args_hint="[ask|analyze|plan|build]",
               subcommands=("ask", "analyze", "analyse", "plan", "build", "status")),
    ...
    CommandDef("reload-mcp", "Reload MCP servers from config", "Tools & Skills",
               aliases=("reload_mcp",)),
    CommandDef("browser", "Start or connect browser tools to your live Chrome via CDP", "Tools & Skills",
